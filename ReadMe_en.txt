...
* The SDK directory description is as follows: 
	SDK 
	й└ йд dist	Build packages directory, including framework and related configuration file .
	й└ йд docs	Document directory, including the development of guidelines, and JavaDoc documentation .
	й└ йд lib	BJAF reference of third-party libraries .
	й└ йд sample	development samples. 
	й╕ йд src	 BJAF source code .
* build instructions 
