...
/**
 * Atomikos TransactionsEssentials Xa数据源连接池封装
 * 
 */
public class XaPool implements IConnPool {
	private AtomikosDataSourceBean adsb = null;
	...
	public void start() {
		if (adsb == null) {
			...
			adsb.setXaDataSourceClassName(driverName);
			Properties p = new Properties();
			p.setProperty("user", username);
			p.setProperty("password", password);
			p.setProperty("URL", conURL);
