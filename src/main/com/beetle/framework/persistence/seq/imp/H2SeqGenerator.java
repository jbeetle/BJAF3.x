...
public class H2SeqGenerator implements ISequence {
	private static H2SeqGenerator generator = new H2SeqGenerator();

	private H2SeqGenerator() {
	...
	public long nextSequenceNum(SeqType seqtype) {
		...
		try {
			...
			e.printStackTrace();
			throw new java.lang.RuntimeException("get h2 sequence err", e);
		}
		return r;
	}

	public SeqImpType getImpType() {
		return SeqType.SeqImpType.H2;
	}
